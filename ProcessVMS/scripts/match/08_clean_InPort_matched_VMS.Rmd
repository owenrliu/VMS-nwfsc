...
filterVMS_dir = "C:/Users/owenr/Documents/postdocs/NOAA NRC/NWFSC work/VMS DATA CONFIDENTIAL/Processed Data/owen processed/clean/"

## file with port coordinates, including directory
coords_file = here::here('Input_Data','port_coords_fromBlake_edited.csv')
...
```{r rawdat}
vms <- read_csv(paste0(filterVMS_dir,"VMS_Outputs_wTARGET_10d_lookback_", years[1], "_speed_cleaned.csv"),col_types='dcTddcddcddddTDcccddd')
dim(vms)
head(vms)
```
<br>
