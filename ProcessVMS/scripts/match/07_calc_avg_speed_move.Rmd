...
Input variables
```{r}
vmsdir <- "C:/Users/owenr/Documents/postdocs/NOAA NRC/NWFSC work/VMS DATA CONFIDENTIAL/Processed Data/owen processed/clean/"
years <- c(2009)
max_speed <- 20 # in m/s
```
<br>
...
```{r read}
vmsdat <- read_csv(paste0(vmsdir,"VMS_Outputs_wTARGET_10d_lookback_", years[1],"_cleaned.csv"),col_types = 'dcTdddcddcdddTDccc')
if(length(years) > 1){
  for(i in years[2:length(years)])
  tmp_vmsdat <- read_csv(paste0(vmsdir,"VMS_Outputs_wTARGET_10d_lookback_", i,"_cleaned.csv"))
